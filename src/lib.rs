...
impl SavedTokens {
    #[new]
    fn new(access_token: String, refresh_token: String, user_id: String, is_premium_user: bool) -> Self {
        Self {
            access_token,
            refresh_token,
            user_id,
...
impl FavouritesList {
    fn __repr__(&self) -> String {
        format!("FavouritesList('{}', {} items)", self.name, self.items.len())
    }
...
impl From<anylist_rs::SyncEvent> for SyncEvent {
    fn from(event: anylist_rs::SyncEvent) -> Self {
        match event {
            ...
            anylist_rs::SyncEvent::StarterListSettingsChanged => SyncEvent::StarterListSettingsChanged,
...
impl AnyListClient {
    ...
    fn login(_py: Python<'_>, email: String, password: String) -> PyResult<Self> {
        ...
        let client = runtime.block_on(async {
            anylist_rs::AnyListClient::login(&email, &password).await
    ...
    fn get_list_by_id(&self, list_id: String) -> PyResult<ShoppingList> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            let list = client.get_list_by_id(&list_id).await
    ...
    fn rename_list(&self, list_id: String, new_name: String) -> PyResult<()> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            client.rename_list(&list_id, &new_name).await
    ...
    fn add_item(&self, list_id: String, name: String) -> PyResult<ListItem> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            let item = client.add_item(&list_id, &name).await
    ...
    fn delete_item(&self, list_id: String, item_id: String) -> PyResult<()> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            client.delete_item(&list_id, &item_id).await
    ...
    fn cross_off_item(&self, list_id: String, item_id: String) -> PyResult<()> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            client.cross_off_item(&list_id, &item_id).await
    ...
    fn uncheck_item(&self, list_id: String, item_id: String) -> PyResult<()> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            client.uncheck_item(&list_id, &item_id).await
    ...
    fn delete_all_crossed_off_items(&self, list_id: String) -> PyResult<()> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            client.delete_all_crossed_off_items(&list_id).await
                .map_err(|e| PyRuntimeError::new_err(format!("Failed to delete crossed off items: {}", e)))
        })
    }
    ...
    fn get_favourites_lists(&self) -> PyResult<Vec<FavouritesList>> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            let lists = client.get_favourites_lists().await
                .map_err(|e| PyRuntimeError::new_err(format!("Failed to get favourites lists: {}", e)))?;
    ...
    fn add_favourite(&self, name: String, category: Option<String>) -> PyResult<FavouriteItem> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            let item = client.add_favourite(&name, category.as_deref()).await
    ...
    fn remove_favourite(&self, list_id: String, item_id: String) -> PyResult<()> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            client.remove_favourite(&list_id, &item_id).await
    ...
    fn get_recipe_by_id(&self, recipe_id: String) -> PyResult<Recipe> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            let recipe = client.get_recipe_by_id(&recipe_id).await
    ...
    fn get_recipe_by_name(&self, name: String) -> PyResult<Recipe> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            let recipe = client.get_recipe_by_name(&name).await
                .map_err(|e| PyRuntimeError::new_err(format!("Failed to get recipe: {}", e)))?;
            Ok(Recipe::from(recipe))
        })
    }
    ...
    fn create_recipe(
        ...
        self.runtime.block_on(async {
            let recipe = client.create_recipe(&name, rust_ingredients, preparation_steps).await
    ...
    fn update_recipe(
        ...
        self.runtime.block_on(async {
            client.update_recipe(&recipe_id, &name, rust_ingredients, preparation_steps).await
    ...
    fn delete_recipe(&self, recipe_id: String) -> PyResult<()> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            client.delete_recipe(&recipe_id).await
    ...
    fn add_recipe_to_list(
        ...
        let client = self.client.clone();
        self.runtime.block_on(async {
            client.add_recipe_to_list(&recipe_id, &list_id, scale_factor).await
                .map_err(|e| PyRuntimeError::new_err(format!("Failed to add recipe to list: {}", e)))
        })
    }
    ...
    fn enable_icalendar(&self) -> PyResult<ICalendarInfo> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            let info = client.enable_icalendar().await
                .map_err(|e| PyRuntimeError::new_err(format!("Failed to enable iCalendar: {}", e)))?;
    ...
    fn disable_icalendar(&self) -> PyResult<()> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            client.disable_icalendar().await
    ...
    fn get_icalendar_url(&self) -> PyResult<Option<String>> {
        let client = self.client.clone();
        self.runtime.block_on(async {
            client.get_icalendar_url().await
    ...
    fn start_realtime_sync(&self) -> PyResult<RealtimeSync> {
        ...
        let sync = self.runtime.block_on(async {
            let sync = client_arc.start_realtime_sync(move |event| {
